<template>
    <div class="side-setting">
        ...
        <setting-item :title="$t('theme.title')">
            <img-checkbox-group @change="(values) => setTheme({ ...theme, mode: values[0] })"
                :default-values="[theme.mode]">
                <img-checkbox :title="$t('theme.dark')" :img="themeDarkSvg" value="dark" />
                <img-checkbox :title="$t('theme.light')" :img="themeLightSvg" value="light" />
                <img-checkbox :title="$t('theme.night')" :img="themeNightSvg" value="night" />
            </img-checkbox-group>
        </setting-item>
        ...
        <setting-item :title="$t('navigate.title')">
            <img-checkbox-group @change="(values) => setLayout(values[0])" :default-values="[layout]">
                <img-checkbox :title="$t('navigate.side')" :img="navSideSvg" value="side" />
                <img-checkbox :title="$t('navigate.head')" :img="navHeadSvg" value="head" />
                <img-checkbox :title="$t('navigate.mix')" :img="navMixSvg" value="mix" />
            </img-checkbox-group>
        </setting-item>
        <setting-item>
            <a-list :split="false">
                <a-list-item>
                    ...
                    <template v-slot:actions>
                        <a-select :getPopupContainer="getPopupContainer" :value="pageWidth" @change="setPageWidth"
                            class="select-item" size="small">
        ...
        <setting-item :title="$t('animate.title')">
            <a-list :split="false">
                <a-list-item>
                    {{ $t('animate.disable') }}
                    <template v-slot:actions>
                        <a-switch :checked="animate.disabled" size="small"
                ...
                <a-list-item>
                    ...
                    <template v-slot:actions>
                        <a-select :value="animate.name" :getPopupContainer="getPopupContainer"
                            @change="(val) => setAnimate({ ...animate, name: val })" class="select-item" size="small">
                ...
                <a-list-item>
                    ...
                    <template v-slot:actions>
                        <a-select :value="animate.direction" :getPopupContainer="getPopupContainer"
                            @change="(val) => setAnimate({ ...animate, direction: val })" class="select-item"
                            size="small">
        ...
        <a-button v-if="isDev" id="copyBtn" :data-clipboard-text="copyConfig" @click="copyCode" style="width: 100%"
