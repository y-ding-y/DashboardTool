<template>
  <div
    :class="isMainPage && 'page'"
    :style="isMainPage && { minHeight: pageMinHeight + 'px' }"
  >
    <a-spin :spinning="loading">
      <div v-if="istitile" :class="['main-header', size]">
        <div
          class="title"
          :style="lang == 'us' ? '' : 'letter-spacing: 0.5vh;'"
        >
...
export default {
  ...
  emits: ['resize', 'submit', 'change', 'refresh', 'exportData', 'exportImage'],
}
</script>
