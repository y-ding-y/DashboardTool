        ...
        <a-spin :spinning="loading">
            <div :class="['header-bar', size]">
                ...
                <div class="actions">
                    ...
                    <action-size v-model:value="sSize" class="action" />
                    <a-tooltip title="列配置">
          ...
          title: undefined,
          loading: false,
        }" :size="sSize" @expandedRowsChange="onExpandedRowsChange" @change="onChange" @expand="onExpand">
                <template :slot="slot" v-for="slot in scopedSlots" v-slot="text, record, index">
    ...
    export default {
        ...
        methods: {
            ...
            onSearchChange(conditions, searchOptions) {
                ...
                $emit(this, 'search', conditions, searchOptions)
            },
            toggleScreen() {
                if (this.fullScreen) {
                    this.outFullScreen()
            ...
            onExpandedRowsChange(expandedRows) {
                $emit(this, 'expandedRowsChange', expandedRows)
            },
            onChange(pagination, filters, sorter, options) {
                $emit(this, 'change', pagination, filters, sorter, options)
            },
            onExpand(expanded, record) {
                $emit(this, 'expand', expanded, record)
            },
            addListener() {
