<template>
  <div
    class="ant-notification-notice"
    :style="{ height: onlineheight + 'px', width: '300px' }"
  >
    <div style="height: 100%; overflow-y: scroll">
      <div class="header-item">
        在線人數：{{ $store.getters['socket/msg'].onlineCount }}
      </div>
    ...
    >
      <div
        ref="chardiv"
        :style="{ height: mainchatheight + 'px' }"
        style="
...
export default {
  ...
  watch: {
    chatlist() {
      this.$nextTick(() => {
        this.$refs['chardiv'].scrollTop =
          this.$refs['chardiv'].scrollHeight - 50
      })
    },
  },
  methods: {
    ...
    hanlde_chat(e) {
      ...
      this.toname = e.name
      if (e.newcount == undefined) e.newcount = 0
